...
class OrderDepth:
    ...
    def __init__(self, buys, sells):
        self.buy_orders: Dict[int, int] = buys
        self.sell_orders: Dict[int, int] = sells
    # def __init__(self):
...
class Trade:
    ...
    def __str__(self) -> str:
        return "(" + self.symbol + ", " + self.buyer + " << " + self.seller + ", " + str(
            self.price) + ", " + str(self.quantity) + ", " + str(self.timestamp) + ")"
